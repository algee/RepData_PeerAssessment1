...
The mean number of steps taken during a day is **`r sprintf("%.2f",dailyStepsMean)`** steps.  

The median number of steps taken during a day is **`r sprintf("%.2f",dailyStepsMedian)`** steps.  
...
The maximum number of steps taken during a day occurs at **(`r sprintf("%2.0f:%2.0f",floor(xmax/60),xmax-floor(xmax/60)*60)` a.m. )**

Histogram of Mean Steps 
-----------------------
**(Missing Values Imputed)**  

There are **(`r sprintf("%2.0f",missingIntervals)` )** intervals with missing data. 

The missing intervals are distributed over **(`r sprintf("%2.0f",length(missingDays))` )** days.   
...
The mean number of steps taken during a day is **`r sprintf("%.2f",dailyStepsMean2)`** steps.  

The median number of steps taken during a day is **`r sprintf("%.2f",dailyStepsMedian2)`** steps.  
